...
# =====================================================================
# 領域1: AI引用 - クエリテンプレート (8個)
# 重要: 企業名を含まないクエリのみ採用。
# 「企業名を入れずに業界の質問をしたとき、AIが自発的にその会社を挙げるか」
# が本来測定すべき AI引用露出度 の本質。
# 0pt (登場なし) が普通。どこで/どのAIで登場するかが重要な評価シグナル。
# =====================================================================
AI_QUERY_TEMPLATES = [
    ("総合", "{業界} のおすすめランキング TOP5"),
    ("総合", "{業界} の主要サービスを比較して"),
    ("価格", "{業界} で料金が安いサービスはどこ"),
    ("品質", "{業界} でサポート評価が高い会社"),
    ("初心者", "{業界} を初めて選ぶ人におすすめ"),
    ("競合比較", "{競合A} と {競合B} はどちらが良い"),
    ("競合比較", "{競合B} と {競合C} の違いを教えて"),
    ("課題", "{業界} の選び方・後悔しない比較方法"),
]
